...
- 클릭 표시: 주소 텍스트 primary 색 + 밑줄

### Fixed [web] — Safari 테마 select 깨짐 (T-1001)
- `#themeSel`에 `appearance:none` + SVG 셰브론 직접 렌더 (Safari 네이티브 크롬 겹침 해소), `:focus` 강조

### Fixed [web] — 모바일 390px 설정 탭 깨짐 (T-1002)
