...
object PersistenceGuard {
    ...
    fun maskSecrets(s: AppSettings): Map<String, Any?> = mapOf(
        ...
        "bootAutoStart" to s.bootAutoStart,
        "launchAutoStart" to s.launchAutoStart,
        "httpsEnabled" to s.httpsEnabled,
        ...
        "torrentStallThresholdKbps" to s.torrentStallThresholdKbps,
        "torrentStallTimeoutSec" to s.torrentStallTimeoutSec,
